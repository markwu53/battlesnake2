...
if __name__ == "__main__":
    ...
    log = {'id': 'd8a9a72d-30c2-42b3-bff8-f791275b304f', 'turn': 79, 'me': {'name': 'mark_snake', 'health': 95, 'length': 11, 'body': [(1, 8), (2, 8), (3, 8), (4, 8), (5, 8), (5, 7), (5, 6), (4, 6), (4, 7), (3, 7), (3, 6)], 'id': 'gs_K68bkyQXJvcRpBw6wbkqJW4T'}, 'others': [{'name': 'SmartyRat', 'health': 31, 'length': 4, 'body': [(7, 4), (7, 3), (6, 3), (6, 2)], 'id': 'gs_tpPffYf9WhB4bvgcPRtRHRpC'}, {'name': 'go-st', 'health': 92, 'length': 9, 'body': [(0, 9), (1, 9), (2, 9), (3, 9), (4, 9), (5, 9), (6, 9), (6, 10), (7, 10)], 'id': 'gs_D6V6dYdj6q6RSx8wvkVQ7qGY'}, {'name': 'ich heisse marvin', 'health': 67, 'length': 9, 'body': [(6, 1), (7, 1), (8, 1), (8, 2), (8, 3), (9, 3), (9, 4), (8, 4), (8, 5)], 'id': 'gs_px4kfDKQTHBKV3GkDjG7myxC'}], 'food': [(0, 8), (2, 5)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'next to food'], 'next_coord': (0, 8), 'next_move': 'left', 'time': '0.053s'}
