...
if __name__ == "__main__":
    ...
    log = {'id': '1ea1c13f-dbf2-45ca-b881-47185fc318b7', 'turn': 89, 'me': {'name': 'mark_snake', 'health': 94, 'length': 9, 'body': [(9, 8), (8, 8), (8, 9), (7, 9), (7, 10), (6, 10), (5, 10), (5, 9), (5, 8)], 'id': 'gs_6Tybd7gRHyByGvkpHmT3cxBd'}, 'others': [{'name': 'Game of Chicken', 'health': 93, 'length': 14, 'body': [(7, 8), (7, 7), (6, 7), (5, 7), (4, 7), (4, 8), (3, 8), (3, 9), (3, 10), (2, 10), (1, 10), (1, 9), (1, 8), (1, 7)], 'id': 'gs_6Y6SyyVXrcFVmjC7WcMFphrd'}, {'name': 'go-st', 'health': 71, 'length': 7, 'body': [(8, 5), (7, 5), (6, 5), (5, 5), (5, 6), (4, 6), (4, 5)], 'id': 'gs_dRfxJ3Gw4CJHJxmG9QmPctVY'}], 'food': [(8, 3)], 'module': 'decision_flow - github', 'decision_path': ['1vn', "vulnerable snakes: [('Game of Chicken', 1, (6, 8))]", "vulnerable but I'm short"], 'next_coord': (9, 9), 'next_move': 'up', 'time': '0.050s'}
