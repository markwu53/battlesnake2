...
if __name__ == "__main__":
    ...
    log = {'id': 'd60b6e00-7e23-4f2c-a365-a485a38d17fe', 'turn': 291, 'me': {'name': 'mark_snake', 'health': 98, 'length': 21, 'body': [(0, 1), (0, 2), (0, 3), (1, 3), (1, 2), (2, 2), (3, 2), (4, 2), (5, 2), (6, 2), (7, 2), (8, 2), (9, 2), (9, 3), (9, 4), (8, 4), (8, 5), (8, 6), (8, 7), (8, 8), (8, 9)], 'id': 'gs_8CbFWkM9mGGSQxvGH7Fj7cGb'}, 'others': [{'name': 'Red Yarn', 'health': 91, 'length': 24, 'body': [(3, 6), (4, 6), (4, 5), (4, 4), (4, 3), (3, 3), (3, 4), (3, 5), (2, 5), (1, 5), (0, 5), (0, 6), (0, 7), (0, 8), (0, 9), (0, 10), (1, 10), (2, 10), (3, 10), (4, 10), (5, 10), (6, 10), (6, 9), (6, 8)], 'id': 'gs_jK8RQ69PgrhRkhphKc8rQKYM'}], 'food': [(2, 8), (6, 1), (8, 0)], 'module': 'decision_flow - github', 'decision_path': ['1v1', 'get food (6, 1)'], 'next_coord': (1, 1), 'next_move': 'right', 'time': '0.020s'}
    log = {'id': 'd60b6e00-7e23-4f2c-a365-a485a38d17fe', 'turn': 292, 'me': {'name': 'mark_snake', 'health': 98, 'length': 21, 'body': [(1,1), (0, 1), (0, 2), (0, 3), (1, 3), (1, 2), (2, 2), (3, 2), (4, 2), (5, 2), (6, 2), (7, 2), (8, 2), (9, 2), (9, 3), (9, 4), (8, 4), (8, 5), (8, 6), (8, 7), (8, 8)], 'id': 'gs_8CbFWkM9mGGSQxvGH7Fj7cGb'}, 'others': [{'name': 'Red Yarn', 'health': 91, 'length': 24, 'body': [(2,6), (3, 6), (4, 6), (4, 5), (4, 4), (4, 3), (3, 3), (3, 4), (3, 5), (2, 5), (1, 5), (0, 5), (0, 6), (0, 7), (0, 8), (0, 9), (0, 10), (1, 10), (2, 10), (3, 10), (4, 10), (5, 10), (6, 10), (6, 9)], 'id': 'gs_jK8RQ69PgrhRkhphKc8rQKYM'}], 'food': [(2, 8), (6, 1), (8, 0)], 'module': 'decision_flow - github', 'decision_path': ['1v1', 'get food (6, 1)'], 'next_coord': (1, 1), 'next_move': 'right', 'time': '0.020s'}
    log = {'id': '5ea8e895-2874-47b4-8cae-ded152b64955', 'turn': 73, 'me': {'name': 'mark_snake', 'health': 90, 'length': 9, 'body': [(5,4), (6, 4), (7, 4), (8, 4), (9, 4), (9, 3), (9, 2), (9, 1), (8, 1)], 'id': 'gs_MfwCPhCvfHmy99mmd4pFB8jW'}, 'others': [{'name': 'go-st', 'health': 83, 'length': 8, 'body': [(4,9), (3, 9), (3, 8), (3, 7), (3, 6), (3, 5), (4, 5), (5, 5)], 'id': 'gs_3WDKCpttCyR48fSmRySxpM9M'}, {'name': 'Red Yarn', 'health': 89, 'length': 8, 'body': [(2,7), (2, 6), (2, 5), (2, 4), (2, 3), (3, 3), (4, 3), (4, 2)], 'id': 'gs_PQBDfRyD9mJqPwvVytbb64tP'}], 'food': [(1, 9), (10, 10)], 'module': 'decision_flow - github', 'decision_path': ['1vn'], 'next_coord': (5, 4), 'next_move': 'left', 'time': '0.063s'}
    log = {'id': '1d04fedb-9aa8-48d5-836d-efd551cd821a', 'turn': 36, 'me': {'name': 'mark_snake', 'health': 91, 'length': 7, 'body': [(5, 5), (5, 4), (6, 4), (7, 4), (8, 4), (9, 4), (10, 4)], 'id': 'gs_DwgkdddxwWmB9dSfSYTjFjdF'}, 'others': [{'name': 'SmartyRat', 'health': 87, 'length': 4, 'body': [(2, 4), (3, 4), (4, 4), (4, 5)], 'id': 'gs_MwGvRB8f6bSPV8FPrH9BD7BC'}, {'name': 'Gregory Megory', 'health': 95, 'length': 7, 'body': [(3, 7), (4, 7), (4, 6), (5, 6), (6, 6), (7, 6), (7, 5)], 'id': 'gs_q8QhWDHRGbtKPhBbF8FWm8qb'}], 'food': [(2, 0), (2, 5), (9, 10)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'split choice all good', 'split2 choose my tail', 'avoid_single_move 1'], 'next_coord': (4, 5), 'next_move': 'left', 'time': '0.050s'}
    log = {'id': 'a2df8b85-6a63-43f9-b8ed-cb1c64da45a4', 'turn': 29, 'me': {'name': 'mark_snake', 'health': 73, 'length': 4, 'body': [(5, 8), (6, 8), (7, 8), (8, 8)], 'id': 'gs_rHSpQSGkTq9pYXpSKDhYyHFb'}, 'others': [{'name': 'Geriatric Jagwire', 'health': 73, 'length': 4, 'body': [(1, 4), (1, 5), (2, 5), (3, 5)], 'id': 'gs_yHyFWDQvdrfQHX8q6Qgcc3HP'}, {'name': 'Natterlie', 'health': 87, 'length': 6, 'body': [(6, 7), (7, 7), (7, 6), (7, 5), (7, 4), (8, 4)], 'id': 'gs_WrrW8YwxKvRJGWpSbQMHgjTc'}, {'name': '@~~~~@', 'health': 100, 'length': 5, 'body': [(4, 9), (4, 8), (4, 7), (5, 7), (5, 7)], 'id': 'gs_jDSkrp4WyprFjDbtvvqvkvgB'}], 'food': [(1, 3), (0, 1)], 'module': 'decision_flow - github', 'decision_path': ['1vn'], 'next_coord': (5, 9), 'next_move': 'up', 'time': '0.000s'}
    log = {'id': 'a2df8b85-6a63-43f9-b8ed-cb1c64da45a4', 'turn': 28, 'me': {'name': 'mark_snake', 'health': 74, 'length': 4, 'body': [(6, 8), (7, 8), (8, 8), (8, 7)], 'id': 'gs_rHSpQSGkTq9pYXpSKDhYyHFb'}, 'others': [{'name': 'Geriatric Jagwire', 'health': 74, 'length': 4, 'body': [(1, 5), (2, 5), (3, 5), (4, 5)], 'id': 'gs_yHyFWDQvdrfQHX8q6Qgcc3HP'}, {'name': 'Natterlie', 'health': 88, 'length': 6, 'body': [(7, 7), (7, 6), (7, 5), (7, 4), (8, 4), (8, 3)], 'id': 'gs_WrrW8YwxKvRJGWpSbQMHgjTc'}, {'name': '@~~~~@', 'health': 74, 'length': 4, 'body': [(4, 8), (4, 7), (5, 7), (6, 7)], 'id': 'gs_jDSkrp4WyprFjDbtvvqvkvgB'}], 'food': [(1, 3), (4, 9), (0, 1)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'avoid type 1 collision [(5, 8), (6, 9)]', 'type 2 collision take avoid point', 'enemy chasing go straight'], 'next_coord': (5, 8), 'next_move': 'left', 'time': '0.032s'}
    log = {'id': '5d6fb213-b3cf-410b-8a06-ecb37ba7ef4d', 'turn': 136, 'me': {'name': 'mark_snake', 'health': 86, 'length': 8, 'body': [(9, 9), (10, 9), (10, 8), (10, 7), (10, 6), (10, 5), (9, 5), (9, 6)], 'id': 'gs_dwh9grtHyMfQWMfbgtqQG8yY'}, 'others': [{'name': 'lackluster oracle', 'health': 89, 'length': 10, 'body': [(8, 8), (7, 8), (7, 7), (6, 7), (6, 8), (6, 9), (5, 9), (5, 8), (4, 8), (3, 8)], 'id': 'gs_JVSqpfygxmMbbRqrtt36yHHb'}, {'name': 'Copy of snake2_v3_FINAL_final(1)', 'health': 92, 'length': 19, 'body': [(5, 1), (4, 1), (4, 0), (5, 0), (6, 0), (7, 0), (8, 0), (9, 0), (10, 0), (10, 1), (9, 1), (8, 1), (8, 2), (9, 2), (10, 2), (10, 3), (9, 3), (8, 3), (8, 4)], 'id': 'gs_TFXRKgjgHTVF783JPwBBFdkd'}, {'name': 'go-st', 'health': 100, 'length': 12, 'body': [(4, 6), (4, 5), (4, 4), (3, 4), (2, 4), (2, 5), (2, 6), (2, 7), (2, 8), (1, 8), (1, 7), (1, 7)], 'id': 'gs_JwmQK38wtqmFpgJDwmkT3yMf'}], 'food': [(4, 7), (5, 10)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'avoid type 1 collision [(9, 10)]'], 'next_coord': (9, 10), 'next_move': 'up', 'time': '0.005s'}
    log = {'id': '531f2108-edb5-4760-b232-8bb59c646499', 'turn': 281, 'me': {'name': 'mark_snake', 'health': 86, 'length': 22, 'body': [(2, 9), (2, 8), (3, 8), (4, 8), (5, 8), (6, 8), (6, 7), (5, 7), (4, 7), (3, 7), (2, 7), (1, 7), (1, 8), (1, 9), (1, 10), (0, 10), (0, 9), (0, 8), (0, 7), (0, 6), (1, 6), (1, 5)], 'id': 'gs_r76w8TPXjtYkFgw3MjbKKdVd'}, 'others': [{'name': 'mini snake', 'health': 81, 'length': 18, 'body': [(8, 3), (8, 4), (8, 5), (7, 5), (7, 6), (8, 6), (9, 6), (9, 7), (8, 7), (8, 8), (8, 9), (7, 9), (6, 9), (6, 10), (5, 10), (5, 9), (4, 9), (3, 9)], 'id': 'gs_qcJQrC3k8CqQvMRXWGMXdD3H'}], 'food': [(10, 9), (7, 10), (8, 1), (6, 2), (6, 1)], 'module': 'decision_flow - github', 'decision_path': ['1v1'], 'next_coord': (3, 9), 'next_move': 'right', 'time': '0.008s'}
    log = {'id': '5b29d0c4-ee48-4753-b2c9-94df54cdea1a', 'turn': 110, 'me': {'name': 'mark_snake', 'health': 95, 'length': 9, 'body': [(9, 1), (9, 2), (9, 3), (9, 4), (10, 4), (10, 5), (9, 5), (9, 6), (8, 6)], 'id': 'gs_Pv9KGSvYqxXBk8M8bgpcQ9CC'}, 'others': [{'name': 'go-st', 'health': 75, 'length': 8, 'body': [(4, 8), (4, 9), (4, 10), (5, 10), (6, 10), (7, 10), (7, 9), (6, 9)], 'id': 'gs_yw4Wd7w7jx67Hf4k6bbm7GBY'}, {'name': 'Natterlie', 'health': 84, 'length': 9, 'body': [(1, 5), (0, 5), (0, 4), (1, 4), (2, 4), (2, 3), (2, 2), (3, 2), (3, 3)], 'id': 'gs_T8CQQWTxD7dqP7kY8fq6qx7K'}, {'name': '@~~~~@', 'health': 100, 'length': 10, 'body': [(8, 0), (8, 1), (8, 2), (8, 3), (8, 4), (7, 4), (7, 5), (7, 6), (7, 7), (7, 7)], 'id': 'gs_8kmKyYr9pB6CxJPPXvk9x4Df'}], 'food': [(9, 7)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'avoid suppressed single collision [(9, 0)]'], 'next_coord': (10, 1), 'next_move': 'right', 'time': '0.002s'}
