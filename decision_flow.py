...
if __name__ == "__main__":
    ...
    log = {'id': '6ad7ed18-2fcc-4288-b406-1ae834b1db98', 'turn': 17, 'me': {'name': 'mark_snake', 'health': 87, 'length': 4, 'body': [(5, 8), (6, 8), (7, 8), (8, 8)], 'id': 'gs_xDXvBmb7rphCgfCDHk4Cm3BR'}, 'others': [{'name': 'slieks', 'health': 95, 'length': 5, 'body': [(6, 9), (7, 9), (8, 9), (8, 10), (9, 10)], 'id': 'gs_qFqSDr4KmM936rTh4HTfJRVG'}, {'name': 'Game of Chicken', 'health': 93, 'length': 5, 'body': [(9, 2), (8, 2), (8, 3), (8, 4), (8, 5)], 'id': 'gs_tbbY3VhgpwYdcV7MT8vJDykc'}, {'name': 'Spaceheater', 'health': 95, 'length': 5, 'body': [(4, 5), (3, 5), (3, 6), (2, 6), (2, 7)], 'id': 'gs_yS8qCTBTtYbHhjMBxWBtPpdD'}], 'food': [(10, 1)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'avoid single collision [(5, 9)]', 'type 2 collision take avoid point', 'enemy chasing go middle'], 'next_coord': (4, 8), 'next_move': 'left', 'time': '0.016s'}
    log = {'id': 'bf66e45c-7c80-4205-a678-6f627b8fc535', 'turn': 99, 'me': {'name': 'mark_snake', 'health': 68, 'length': 6, 'body': [(8, 7), (8, 6), (8, 5), (9, 5), (9, 6), (9, 7)], 'id': 'gs_jRQ3J8ttpWfcWdVFkJGwwtQ6'}, 'others': [{'name': 'SmartyRat', 'health': 72, 'length': 8, 'body': [(8, 3), (8, 4), (7, 4), (7, 3), (7, 2), (6, 2), (6, 3), (5, 3)], 'id': 'gs_7qD8fbMHj9QBP8gVbdXXFwYK'}, {'name': 'slieks', 'health': 100, 'length': 14, 'body': [(8, 9), (9, 9), (10, 9), (10, 8), (9, 8), (8, 8), (7, 8), (6, 8), (5, 8), (5, 7), (5, 6), (4, 6), (4, 5), (4, 5)], 'id': 'gs_83HGYBTftvQckwGm8pxw7MVD'}, {'name': 'Gregory Megory', 'health': 88, 'length': 9, 'body': [(3, 4), (3, 3), (3, 2), (2, 2), (2, 3), (1, 3), (0, 3), (0, 2), (1, 2)], 'id': 'gs_mDJ77WcWPHPmpHxqghCJkdwb'}], 'food': [(4, 1)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'split2 choose my tail'], 'next_coord': (9, 7), 'next_move': 'right', 'time': '0.018s'}
