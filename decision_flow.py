...
if __name__ == "__main__":
    ...
    log = {'id': '58c4b3e9-46bd-4c2c-8d49-0448b7b2f499', 'turn': 35, 'me': {'name': 'mark_snake', 'health': 67, 'length': 4, 'body': [(9, 2), (9, 1), (9, 0), (8, 0)], 'id': 'gs_yHxmxy8QMBr8wpRMTYBjMXh8'}, 'others': [{'name': 'Wim HU', 'health': 98, 'length': 7, 'body': [(9, 6), (10, 6), (10, 5), (10, 4), (10, 3), (9, 3), (9, 4)], 'id': 'gs_BFTK38BtkbYDFgq47SFqgSHM'}, {'name': 'Geriatric Jagwire', 'health': 90, 'length': 5, 'body': [(6, 5), (5, 5), (4, 5), (4, 4), (3, 4)], 'id': 'gs_dc39fh6Pgr3FXK7Fhd4qb8b9'}, {'name': 'poc', 'health': 75, 'length': 5, 'body': [(7, 2), (7, 3), (7, 4), (6, 4), (6, 3)], 'id': 'gs_kVYb668XBrmCpMBVbJ3mgtwD'}], 'food': [(1, 8), (5, 8)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'avoid type 1 collision [(10, 2)]'], 'next_coord': (10, 2), 'next_move': 'right', 'time': '0.015s'}
    log = {'id': '26a858f2-ba98-4f69-86a0-2e5b862e2131', 'turn': 116, 'me': {'name': 'mark_snake', 'health': 99, 'length': 9, 'body': [(1, 9), (0, 9), (0, 8), (0, 7), (1, 7), (2, 7), (2, 8), (2, 9), (3, 9)], 'id': 'gs_c8dBr8pxkjvrrWqXbW3Kpq6K'}, 'others': [{'name': 'Game of Chicken', 'health': 97, 'length': 11, 'body': [(9, 7), (10, 7), (10, 8), (10, 9), (10, 10), (9, 10), (8, 10), (7, 10), (6, 10), (6, 9), (6, 8)], 'id': 'gs_PxK6KScXP9yrkYYWrBrFmwMF'}, {'name': 'SnattleBake_v027', 'health': 54, 'length': 7, 'body': [(4, 4), (5, 4), (5, 5), (4, 5), (3, 5), (3, 4), (3, 3)], 'id': 'gs_HxXHj9FY6VXw9PhYFXrCW9YG'}, {'name': 'ich heisse marvin', 'health': 89, 'length': 8, 'body': [(6, 2), (6, 1), (5, 1), (4, 1), (3, 1), (3, 2), (4, 2), (5, 2)], 'id': 'gs_YXfdtSjBrhwKbcfDWGxcxvQT'}], 'food': [(9, 5), (1, 0)], 'module': 'decision_flow - github', 'decision_path': ['1vn', "vulnerable snakes: [('SnattleBake_v027', 1, (4, 3))]", 'avoid next step no move [(1, 8)]'], 'next_coord': (1, 10), 'next_move': 'up', 'time': '0.003s'}
