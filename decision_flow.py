...
if __name__ == "__main__":
    ...
    log = {'id': '0dcfaa5d-259a-4357-a381-c8dc8763884f', 'turn': 37, 'me': {'name': 'mark_snake', 'health': 87, 'length': 6, 'body': [(9, 2), (8, 2), (7, 2), (6, 2), (5, 2), (5, 3)], 'id': 'gs_YrvxWJgVtwBDXDKV8fV9GYg3'}, 'others': [{'name': 'go-st', 'health': 97, 'length': 9, 'body': [(8, 1), (7, 1), (6, 1), (5, 1), (4, 1), (3, 1), (2, 1), (1, 1), (1, 2)], 'id': 'gs_xT3jMhVfT3kx9f3Mv876HMhJ'}, {'name': 'ich heisse marvin', 'health': 77, 'length': 5, 'body': [(4, 5), (4, 6), (4, 7), (4, 8), (3, 8)], 'id': 'gs_HKH9SpYG3YBM9BC3j7wpRQd8'}, {'name': '@~~~~@', 'health': 96, 'length': 8, 'body': [(7, 6), (8, 6), (8, 7), (8, 8), (7, 8), (6, 8), (6, 7), (7, 7)], 'id': 'gs_bP3kVqRfVQrc8hCvRCkYgDkd'}], 'food': [(2, 4), (6, 4)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'collision type 2 take risk'], 'next_coord': (9, 1), 'next_move': 'down', 'time': '0.028s'}
    ...
    log = {'id': '02623fb7-70e3-42fe-91f9-006933293ae5', 'turn': 3, 'me': {'name': 'mark_snake', 'health': 97, 'length': 3, 'body': [(9, 10), (10, 10), (10, 9)], 'id': 'gs_Mjq73mbDpqrGgTMmXdwBR9Yc'}, 'others': [{'name': '@~~~~@', 'health': 99, 'length': 4, 'body': [(7, 0), (8, 0), (8, 1), (9, 1)], 'id': 'gs_CdgkhBcjcpbbxgbcBqRJwtcK'}, {'name': 'Gregory Megory', 'health': 99, 'length': 4, 'body': [(2, 1), (2, 0), (1, 0), (1, 1)], 'id': 'gs_RxK3KpGkjR8M4Y8xmWKC8jY8'}, {'name': 'Slytherin', 'health': 99, 'length': 4, 'body': [(0, 7), (0, 8), (0, 9), (1, 9)], 'id': 'gs_DPQ97gmYvbpcQd6MryP78RPV'}], 'food': [(8, 10), (5, 5), (5, 7), (1, 7)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'next to food'], 'next_coord': (8, 10), 'next_move': 'left', 'time': '0.043s'}
    log = {'id': '02623fb7-70e3-42fe-91f9-006933293ae5', 'turn': 4, 'me': {'name': 'mark_snake', 'health': 97, 'length': 4, 'body': [(8,10), (9, 10), (10, 10), (10, 10)], 'id': 'gs_Mjq73mbDpqrGgTMmXdwBR9Yc'}, 'others': [{'name': '@~~~~@', 'health': 99, 'length': 4, 'body': [(7,1), (7, 0), (8, 0), (8, 1)], 'id': 'gs_CdgkhBcjcpbbxgbcBqRJwtcK'}, {'name': 'Gregory Megory', 'health': 99, 'length': 4, 'body': [(2,2), (2, 1), (2, 0), (1, 0)], 'id': 'gs_RxK3KpGkjR8M4Y8xmWKC8jY8'}, {'name': 'Slytherin', 'health': 100, 'length': 5, 'body': [(1,7), (0, 7), (0, 8), (0, 9), (0, 9)], 'id': 'gs_DPQ97gmYvbpcQd6MryP78RPV'}], 'food': [(5, 5), (5, 7)], 'module': 'decision_flow - github', 'decision_path': ['1vn', 'next to food'], 'next_coord': (8, 10), 'next_move': 'left', 'time': '0.043s'}
