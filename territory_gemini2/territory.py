...
if __name__ == "__main__":
    ...
    log = {'id': '5dc59340-5427-4bff-a442-ae54a5071044', 'turn': 57, 'me': {'name': 'mark_snake', 'health': 97, 'length': 9, 'body': [(6, 1), (7, 1), (8, 1), (9, 1), (9, 2), (9, 3), (9, 4), (9, 5), (10, 5)], 'id': 'gs_hBtq7HbQVbrfRWQmqHMPyhJS'}, 'others': [{'name': 'mini snake', 'health': 79, 'length': 7, 'body': [(8, 7), (9, 7), (9, 8), (10, 8), (10, 9), (9, 9), (8, 9)], 'id': 'gs_gWF86qDmGjthqJFrQvt8ByfK'}, {'name': 'Aurora', 'health': 74, 'length': 7, 'body': [(5, 2), (5, 3), (5, 4), (5, 5), (4, 5), (3, 5), (3, 4)], 'id': 'gs_8yrFWr8Qc9CfRxCcwHpkjRkY'}, {'name': 'Geriatric Jagwire', 'health': 82, 'length': 7, 'body': [(3, 8), (3, 9), (3, 10), (4, 10), (5, 10), (5, 9), (5, 8)], 'id': 'gs_FyJhRt7QxQJ7FHpSxkTGrkpT'}], 'food': [(6, 10), (1, 0)], 'module': 'territory', 'decision_path': ['get food (1, 0) via [(6, 0)]'], 'next_coord': (6, 0), 'next_move': 'down', 'time': '0.116s'}
    log = {'id': '5dc59340-5427-4bff-a442-ae54a5071044', 'turn': 57, 'me': {'name': 'mark_snake', 'health': 97, 'length': 9, 'body': [(6, 1), (7, 1), (8, 1), (9, 1), (9, 2), (9, 3), (9, 4), (9, 5), (10, 5)], 'id': 'gs_hBtq7HbQVbrfRWQmqHMPyhJS'}, 'others': [{'name': 'mini snake', 'health': 79, 'length': 7, 'body': [(8, 7), (9, 7), (9, 8), (10, 8), (10, 9), (9, 9), (8, 9)], 'id': 'gs_gWF86qDmGjthqJFrQvt8ByfK'}, {'name': 'Aurora', 'health': 74, 'length': 7, 'body': [(5, 2), (5, 3), (5, 4), (5, 5), (4, 5), (3, 5), (3, 4)], 'id': 'gs_8yrFWr8Qc9CfRxCcwHpkjRkY'}, {'name': 'Geriatric Jagwire', 'health': 82, 'length': 7, 'body': [(3, 8), (3, 9), (3, 10), (4, 10), (5, 10), (5, 9), (5, 8)], 'id': 'gs_FyJhRt7QxQJ7FHpSxkTGrkpT'}], 'food': [(6, 10)], 'module': 'territory', 'decision_path': ['get food (1, 0) via [(6, 0)]'], 'next_coord': (6, 0), 'next_move': 'down', 'time': '0.116s'}
    log = {'id': '7dda3039-472f-4a71-b7d0-8cb480e27bb3', 'turn': 48, 'me': {'name': 'mark_snake_test RED', 'health': 94, 'length': 9, 'body': [(7, 5), (6, 5), (5, 5), (4, 5), (4, 6), (4, 7), (3, 7), (3, 8), (2, 8)], 'id': 'mark_snake_test RED'}, 'others': [{'name': 'mark_snake_test BLUE', 'health': 99, 'length': 8, 'body': [(10, 2), (10, 3), (9, 3), (8, 3), (7, 3), (6, 3), (5, 3), (5, 4)], 'id': 'mark_snake_test BLUE'}, {'name': 'mark_snake_test GREEN', 'health': 98, 'length': 9, 'body': [(1, 1), (1, 0), (2, 0), (2, 1), (2, 2), (2, 3), (1, 3), (1, 4), (1, 5)], 'id': 'mark_snake_test GREEN'}, {'name': 'mark_snake_test YELLOW', 'health': 73, 'length': 6, 'body': [(4, 4), (4, 3), (4, 2), (4, 1), (3, 1), (3, 2)], 'id': 'mark_snake_test YELLOW'}], 'food': [(0, 0), (1, 8)], 'module': 'territory', 'decision_path': [], 'next_coord': (8, 5), 'next_move': 'right', 'time': '0.038s'}
    log = {'id': '7dda3039-472f-4a71-b7d0-8cb480e27bb3', 'turn': 49, 'nalive': 4, 'snakes': [{'name': 'mark_snake_test RED', 'health': 93, 'length': 9, 'alive': True, 'delay': 37, 'body': [(8, 5), (7, 5), (6, 5), (5, 5), (4, 5), (4, 6), (4, 7), (3, 7), (3, 8)]}, {'name': 'mark_snake_test BLUE', 'health': 98, 'length': 8, 'alive': True, 'delay': 13, 'body': [(9, 2), (10, 2), (10, 3), (9, 3), (8, 3), (7, 3), (6, 3), (5, 3)]}, {'name': 'mark_snake_test GREEN', 'health': 97, 'length': 9, 'alive': True, 'delay': 37, 'body': [(0, 1), (1, 1), (1, 0), (2, 0), (2, 1), (2, 2), (2, 3), (1, 3), (1, 4)]}, {'name': 'mark_snake_test YELLOW', 'health': 72, 'length': 6, 'alive': True, 'delay': 51, 'body': [(3, 4), (4, 4), (4, 3), (4, 2), (4, 1), (3, 1)]}], 'food': [(0, 0), (1, 8), (9, 4)]}
    ...
    log = {'id': 'e8936795-115e-41e4-a110-cac02442db0d', 'turn': 132, 'nalive': 3, 'snakes': [{'name': 'mark_snake_test RED', 'health': 95, 'length': 10, 'alive': True, 'delay': 26, 'body': [(8, 10), (9, 10), (10, 10), (10, 9), (10, 8), (10, 7), (9, 7), (8, 7), (8, 8), (8, 9)]}, {'name': 'mark_snake_test BLUE', 'health': 100, 'length': 19, 'alive': True, 'delay': 4, 'body': [(10, 4), (9, 4), (8, 4), (7, 4), (7, 5), (7, 6), (7, 7), (7, 8), (7, 9), (6, 9), (5, 9), (4, 9), (3, 9), (2, 9), (1, 9), (0, 9), (0, 8), (1, 8), (1, 8)]}, {'name': 'mark_snake_test GREEN', 'health': 68, 'length': 11, 'alive': False, 'delay': 0, 'body': [(9, 0), (10, 0), (9, 0), (8, 0), (7, 0), (6, 0), (6, 1), (5, 1), (5, 0), (4, 0), (3, 0)]}, {'name': 'mark_snake_test YELLOW', 'health': 92, 'length': 17, 'alive': True, 'delay': 1, 'body': [(10, 2), (10, 3), (9, 3), (9, 2), (9, 1), (8, 1), (7, 1), (6, 1), (5, 1), (4, 1), (3, 1), (2, 1), (1, 1), (1, 2), (1, 3), (1, 4), (2, 4)]}], 'food': [(0, 6), (8, 6)]}
    log = {'id': 'c8b265e2-b722-41e7-a83c-c5ceb5a9e45e', 'turn': 45, 'nalive': 4, 'snakes': [{'name': 'mark_snake_test RED', 'health': 64, 'length': 6, 'alive': True, 'delay': 2, 'body': [(0, 5), (0, 4), (1, 4), (2, 4), (3, 4), (3, 5)]}, {'name': 'mark_snake_test BLUE', 'health': 95, 'length': 7, 'alive': True, 'delay': 31, 'body': [(1, 2), (1, 3), (2, 3), (2, 2), (3, 2), (4, 2), (5, 2)]}, {'name': 'mark_snake_test GREEN', 'health': 96, 'length': 10, 'alive': True, 'delay': 50, 'body': [(10, 1), (10, 2), (10, 3), (10, 4), (10, 5), (10, 6), (10, 7), (10, 8), (10, 9), (10, 10)]}, {'name': 'mark_snake_test YELLOW', 'health': 98, 'length': 8, 'alive': True, 'delay': 31, 'body': [(3, 6), (4, 6), (4, 5), (4, 4), (5, 4), (5, 5), (5, 6), (5, 7)]}], 'food': [(0, 9)]}
    log = {'id': '2a91c5f1-be74-4117-8d29-486cd8cb5e34', 'turn': 117, 'me': {'name': 'mark_snake', 'health': 95, 'length': 12, 'body': [(6, 1), (7, 1), (8, 1), (8, 2), (9, 2), (10, 2), (10, 3), (10, 4), (10, 5), (10, 6), (9, 6), (9, 5)], 'id': 'gs_88CfGS4c7g4YMWJ7dH4TdytB'}, 'others': [{'name': 'mini snake', 'health': 99, 'length': 8, 'body': [(5, 2), (5, 1), (5, 0), (4, 0), (4, 1), (4, 2), (4, 3), (5, 3)], 'id': 'gs_yvdyKqYqtpgmT9yF4yWGR8bH'}, {'name': 'SmartyRat', 'health': 93, 'length': 9, 'body': [(4, 7), (4, 8), (5, 8), (6, 8), (6, 9), (7, 9), (7, 10), (8, 10), (9, 10)], 'id': 'gs_kCXPmDq9X7yS9Gmd7cfFPfmP'}, {'name': 'Geriatric Jagwire', 'health': 88, 'length': 13, 'body': [(5, 4), (5, 5), (4, 5), (3, 5), (3, 6), (2, 6), (2, 5), (2, 4), (2, 3), (1, 3), (0, 3), (0, 2), (0, 1)], 'id': 'gs_vw9JrY38XbYgXk9WpjRFGM6Q'}], 'food': [(0, 9), (9, 0)], 'module': 'territory', 'decision_path': ['avoided suppress (6, 2) from Geriatric Jagwire'], 'next_coord': (6, 0), 'next_move': 'down', 'time': '0.010s'}
    log = {'id': 'a26bd410-43f3-469a-84ff-dde4bfbfc849', 'turn': 190, 'me': {'name': 'mark_snake', 'health': 92, 'length': 17, 'body': [(1, 3), (0, 3), (0, 4), (0, 5), (0, 6), (1, 6), (1, 7), (2, 7), (2, 8), (3, 8), (4, 8), (4, 7), (5, 7), (6, 7), (6, 8), (5, 8), (5, 9)], 'id': 'gs_6fmhBkq378RQkktMrRPTXmvD'}, 'others': [{'name': 'Game of Chicken', 'health': 96, 'length': 17, 'body': [(10, 4), (10, 3), (10, 2), (10, 1), (10, 0), (9, 0), (9, 1), (8, 1), (8, 2), (8, 3), (8, 4), (8, 5), (7, 5), (6, 5), (5, 5), (5, 6), (4, 6)], 'id': 'gs_ybkpvXQS97P9C3bkC4jgwF7Q'}, {'name': 'Hovering Hobbs', 'health': 80, 'length': 7, 'body': [(2, 2), (3, 2), (4, 2), (5, 2), (5, 3), (4, 3), (3, 3)], 'id': 'gs_4Vgff7jJtwS7qHymfrSwqDk8'}], 'food': [(0, 1), (8, 6)], 'module': 'territory', 'decision_path': ['get food (0, 1) via [(1, 2)]'], 'next_coord': (1, 2), 'next_move': 'down', 'time': '0.097s'}
    log = {'id': '98c8fb72-49f3-4891-9a6f-958d52d3f6f5', 'turn': 416, 'me': {'name': 'mark_snake', 'health': 92, 'length': 33, 'body': [(9, 5), (9, 6), (9, 7), (9, 8), (9, 9), (9, 10), (8, 10), (7, 10), (6, 10), (5, 10), (4, 10), (3, 10), (3, 9), (3, 8), (2, 8), (1, 8), (1, 7), (1, 6), (1, 5), (2, 5), (3, 5), (3, 4), (3, 3), (3, 2), (3, 1), (3, 0), (4, 0), (5, 0), (6, 0), (7, 0), (8, 0), (9, 0), (10, 0)], 'id': 'gs_7bJYfq7fBMhfCckJvPW34DvX'}, 'others': [{'name': 'Aurora', 'health': 92, 'length': 21, 'body': [(8, 4), (7, 4), (7, 3), (6, 3), (5, 3), (5, 4), (6, 4), (6, 5), (6, 6), (6, 7), (5, 7), (5, 6), (4, 6), (4, 7), (4, 8), (5, 8), (6, 8), (7, 8), (7, 7), (7, 6), (7, 5)], 'id': 'gs_KQrKWBDXBH3gcHVjW4BXYP4F'}], 'food': [(0, 10), (1, 2), (2, 2), (1, 4), (5, 2), (2, 7), (1, 0), (0, 9), (10, 7)], 'module': 'territory', 'decision_path': ['general possible confine (10, 5)', 'border analysis move go (9, 4)'], 'next_coord': (9, 4), 'next_move': 'down', 'time': '0.068s'}
